...
ARTWORK_PROMPT = (
    ...
    "very wide strip through the vertical center, so keep every important element inside that "
    "central band and leave plain empty white above and below it. If the description implies a "
